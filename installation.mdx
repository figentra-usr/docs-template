...
description: "Install and configure @figentra/* packages in a TypeScript monorepo with pnpm workspaces, strict TypeScript settings, and shared base configuration."
---
