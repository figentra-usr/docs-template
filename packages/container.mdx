...
description: "Register and resolve typed dependencies with @figentra/container's lightweight DI container — supports singleton and transient scopes with full TypeScript inference."
---
