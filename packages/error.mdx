...
sidebarTitle: "Error"
description: "Throw and catch typed errors consistently across your Figentra app with typed error classes, HTTP status codes, and instanceof narrowing helpers."
---
