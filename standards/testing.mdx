...
<Steps>
  <Step title="80%+ line coverage on all packages">
    Every published package must reach at least 80% line coverage. The CI pipeline enforces this threshold and blocks merges that fall below it.
  </Step>
